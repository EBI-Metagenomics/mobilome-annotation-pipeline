...
This workflow has the folowing main subworkflows:
 ...
 - Postprocessing: Write the mobilome fasta file, write a report of the location of AMR genes (whether mobilome or chromosome), and generate three new files of the GFF file:
