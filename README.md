...
Two additional databases need to be manually downloaded and extracted: [AMRFinderPlus](https://ftp.ncbi.nlm.nih.gov/pathogen/Antimicrobial_resistance/AMRFinderPlus/database/latest) and the [geNomad](https://zenodo.org/records/8339387) databases. Then you can provide the paths to your databases using the `mobileog_db`, `amrfinder_plus_db`, and `genomad_db` parameters respectively when you run the pipeline.
