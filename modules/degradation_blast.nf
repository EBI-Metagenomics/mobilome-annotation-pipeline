process DEGRADATION_BLAST {
    ...
    output:
    tuple val(meta), path("*.deg.m8"), emit: blast_results
    tuple val(meta), path("*.deg.filtered"), emit: filtered_results
