...
class TestFastCompositionAnalyzer:
    ...
    def test_calculate_fast_outlier_scores(self):
        ...
        for window in windows:
            window = window._replace(kmer_profile={"3mer_AAA": 0.25, "3mer_TTT": 0.25, "3mer_GGG": 0.25, "3mer_CCC": 0.25})
        ...
        assert scored_windows[1].gc_score > scored_windows[0].gc_score  # High GC outlier
...
class TestFastRepeatFinder:
    ...
    def test_init(self):
        ...
        finder = FastRepeatFinder(flank_window=200, min_repeat_length=5, max_repeat_length=50)
    ...
    def test_find_flanking_repeats_with_repeats(self):
        ...
        finder = FastRepeatFinder(flank_window=20, min_repeat_length=5, max_repeat_length=15)
