...
class TestParseBlastUniprot:
    ...
    def test_parse_blast_uniprot_valid_input(self):
        ...
        expected = {"query1": "product1", "query2": "product2", "query3": "product3"}
...
contig_1\tprodigal\tCDS\t600\t900\t.\t-\t.\tID=CP003200_00019;ori_id=contig_1_18"""
        ...
        uniprot_dict = {
            "contig_1_17": "hypothetical protein",
            "contig_1_18": "integrase",
        }
    ...
    def test_merge_trna_basic(self):
        ...
        posdict = {
            ...
            "CP003200_00012": [
                ...
                3469343,
                "+",
                "Type IV secretion system protein PtlA",
            ],
        }
