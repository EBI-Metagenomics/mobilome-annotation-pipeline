...
def main():
    parser = argparse.ArgumentParser(description='Process vmatch output to identify direct repeats')
    parser.add_argument('vmatch_file', help='Input vmatch output file')
    parser.add_argument('output_file', help='Output TSV file with processed direct repeats')
