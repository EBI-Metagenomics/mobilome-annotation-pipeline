...
parser = argparse.ArgumentParser(
        description='This script filter by contig size a metagenomic assembly and generates two files to feed the MoMofy pipeline: contigs > 1kb for insertion sequences prediction and contigs > 5 kb for integron prediction')
...
counter=0
with open(output_1kb, 'w') as to_1kb, open(output_5kb, 'w') as to_5kb, open(output_map, 'w') as to_map:
