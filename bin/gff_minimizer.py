...
parser.add_argument('--momoviri', type=str, help='Mobilome annotation file (gff)')
...
if os.path.isfile(annot):
    with open(annot,'r') as input_file, open('mobilome_clean.gff', 'w') as to_clean_gff, open('mobilome_extra.gff', 'w') as to_extra_gff, open ('mobilome_nogenes.gff', 'w') as to_nogenes_gff:
                ...
                if seq_type in flank:
                    ...
                    if 'from_mge' in attr:
                        ...
                        if any([ 'viphog=' in attr , 'mobileOG=mobileOG' in attr ]):
                            ...
                            to_extra_gff.write(updated_line+'\n')
