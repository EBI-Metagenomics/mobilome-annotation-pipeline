...
workflow ICEFINDER2_LITE {
    ...
    def prescan_input_ch = HMMSCAN.out.hmmscan_tbl
    ...
    def ch_candidates = PRESCAN_TO_FASTA.out.candidates_faa
     ...
     */
    def ch_assembly_filtered = ch_icf2_split.assem
    ...
    def ch_gff_filtered = ch_icf2_split.gff
