include { DIAMOND_BLASTP as MOBILEOG_DIAMOND_BLAST                 } from '../modules/nf-core/diamond/blastp'
...
include { FILTER_BLAST_RESULTS as FILTER_BLAST_RESULTS_RESFINDER   } from '../modules/local/filter_blast_results'
include { FILTER_BLAST_RESULTS as FILTER_BLAST_RESULTS_VFDB        } from '../modules/local/filter_blast_results'
include { FILTER_BLAST_RESULTS as FILTER_BLAST_RESULTS_ISFINDER    } from '../modules/local/filter_blast_results'
include { FILTER_BLAST_RESULTS as FILTER_BLAST_RESULTS_METAL       } from '../modules/local/filter_blast_results'
include { FILTER_BLAST_RESULTS as FILTER_BLAST_RESULTS_DEGRADATION } from '../modules/local/filter_blast_results'
include { FILTER_BLAST_RESULTS as FILTER_BLAST_RESULTS_SYMBIOSIS   } from '../modules/local/filter_blast_results'
...
workflow BLAST_ANNOTATIONS {
    ...
    MOBILEOG_DIAMOND_BLAST(ch_faa, ch_mobileog_db, 5, '6 stitle qtitle pident bitscore slen evalue qlen sstart send qstart qend')
    ...
    FILTER_BLAST_RESULTS_RESFINDER(RESFINDER_BLAST.out.txt, 0.81)
    FILTER_BLAST_RESULTS_VFDB(VFDB_BLAST.out.tsv, 0.64)
    FILTER_BLAST_RESULTS_ISFINDER(ISFINDER_BLAST.out.tsv, 0.70)
    FILTER_BLAST_RESULTS_METAL(METAL_RESISTANCE_BLAST.out.tsv, 0.70)
    FILTER_BLAST_RESULTS_DEGRADATION(DEGRADATION_BLAST.out.tsv, 0.70)
    FILTER_BLAST_RESULTS_SYMBIOSIS(SYMBIOSIS_BLAST.out.txt, 0.70)

    // Collect versions
    ch_versions = ch_versions.mix(MOBILEOG_DIAMOND_BLAST.out.versions)
